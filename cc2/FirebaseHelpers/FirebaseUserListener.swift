...
class FirebaseUserListener {
    ...
    func downloadAllUsersFromFirebase(completion: @escaping(_ allUesrs: [User]) -> Void) {
    ...
    func downloadUsersFromFirebase(withIds: [String] ,completion: @escaping(_ allUesrs: [User]) -> Void) {
